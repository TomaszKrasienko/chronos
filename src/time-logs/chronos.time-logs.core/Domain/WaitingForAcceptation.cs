...
/// </summary>
public sealed class WaitingForAcceptation : TimeLog
{
    /// <summary>
    ...
    private WaitingForAcceptation(
        ...
        string? notes,
        DateTime createdAt,
        Ulid supervisorId) : base(id, employeeId, contractId, hours, topic, notes, createdAt)
    {
    ...
    public static WaitingForAcceptation Create(
        Ulid employeeId,
        Ulid contractId,
        LoggedHours hours,
        string topic,
